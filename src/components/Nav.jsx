...
import { Button, AppBar,ButtonGroup, Typography, Toolbar } from "@mui/material";
...
const Nav = () => {
  ...
  return (
    <AppBar sx={{position: 'static', bgcolor: '#2b317a'}}>
      ...
      <Typography alignContent='right' sx={{marginLeft:'1rem'}}> Welcome back {currentUser}!</Typography>
      </Toolbar>
      </AppBar>
  );
};
